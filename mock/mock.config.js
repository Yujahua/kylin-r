...
const config = {};
 ...
 const Axios=axios.create({
    baseURL: '', // 本地做了反向代理 会直接走express 中use的地址
    timeout: 40000,
    responseType: 'json',
...
config.call = {
    ...
    rpc: function (opts, callback) {
        // 区分本地mock 和 本地调试 mock 
        if(opts.operationType.indexOf("js")==-1){
            ...
            var responsedata = {};
            Axios.post(opts.operationType, opts.requestData[0]['_requestBody']).then(
              function (response) {
